1. Briefly describe the conceptual approach you chose! What are the trade-offs?
	a. Useing ubuntu:16.04 image created on google cloud useing IaaC Templates
	b. Docker images created useing docker file uploaded by me on github at https://github.com/chandrasekhar-DevOps/QuarticCodeChallenge.git
	c. Kubernetes Cluster and Load Balancer created
	d. useing uWSGI to communictae with Django application
...
3. What will be the annual cost of hosting this solution for 1 year for 10K concurrent users. Describe your method.
	...
	Considering low oferrings of storage cost by varies cloud providers, I am focusing more on compute and IO costs
